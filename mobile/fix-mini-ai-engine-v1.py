...
root=Path.cwd(); app=root/'generated'/'JyotishG'; src=root/'mobile'; path=app/'App.tsx'
...
print('Jyotish G uses learned offline semantic model + context-safe multilingual chat engine')
