...
if not app.exists(): raise SystemExit('Generated AstroSathi project not found')
...
print('AstroSathi premium client now uses the single webhook backend; direct Telegram polling removed')
