...
for name in ('install-overlay-base.py', 'install-premium-v2.py', 'fix-guidance-v2.py', 'install-guidance-v2.py', 'install-premium-state-v3.py', 'install-birth-input-v2.py', 'install-place-search-v3.py'):
    path = scripts / name
    if not path.exists():
