...
root=Path.cwd(); src=root/'mobile'; app=root/'generated'/'JyotishG'; path=app/'App.tsx'
...
print('Jyotish G chart prediction overlay installed: nature, current pressures, recent-period clues and near-term chart-derived themes')
